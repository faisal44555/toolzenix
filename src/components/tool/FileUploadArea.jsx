    ...
    import { UploadCloud, FileText, RotateCw, Image as ImageIconLucide } from 'lucide-react';
    ...
    export function FileUploadArea({ 
      ...
      const DisplayIcon = selectedFile?.type?.startsWith('image/') ? ImageIconLucide : FileText;
        ...
        <>
          {!selectedFile ? (
            ...
            >
              ...
              <Input id="file-upload" type="file" onChange={onFileChange} className="hidden" accept={accept} />
            </label>
          ) : (
            <motion.div 
            ...
            >
              <DisplayIcon className="h-10 w-10 md:h-12 md:w-12 text-blue-500 mx-auto mb-2 md:mb-3" />
