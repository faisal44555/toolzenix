...
import { Clipboard, RefreshCw, ArrowDown } from "lucide-react";
    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      >
        ...
        <p className="text-lg text-gray-700 dark:text-gray-300">
          Convert all characters in your text to lowercase.
        </p>
      </motion.div>
      ...
      >
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg">
            <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">Output (Lowercase)</h2>
            <textarea
              value={outputText}
              readOnly
