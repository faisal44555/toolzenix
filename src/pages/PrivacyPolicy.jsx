...
const PrivacyPolicy = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Privacy Policy | Toolzenix.com</title>
        ...
        <meta property="og:title" content="Privacy Policy | Toolzenix.com" />
        ...
        <meta property="og:url" content="https://www.toolzenix.com/privacy-policy" />
        <meta property="og:type" content="website" />
        <link rel="canonical" href="https://www.toolzenix.com/privacy-policy" />
      </Helmet>
      <motion.div 
      ...
      >
        ...
        >
          <h1 className="text-5xl font-extrabold mb-4">
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-600 dark:from-blue-400 dark:via-indigo-400 dark:to-purple-500">Privacy Policy</span>
          </h1>
